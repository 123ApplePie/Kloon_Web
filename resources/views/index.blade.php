    ...
    <section>
      <div class="container" style="padding-top: 5%; padding-bottom: 5%;">
          <div class="row">
              <div class="col-md-7">
                  <div class="card-body">
                      <h3 class="font-weight-bold" style="font-size: 40px;">Van basis tot maatwerk met strategisch advies</h3>
                      <p class="card-text" style="font-size: 22px;">
                      ...
                      <br>
                      <h3 class="font-weight-bold" style="font-size: 40px;">De basis is altijd goed</h3>
                      <p class="card-text" style="font-size: 22px;">
          ...
          <div class="d-flex justify-content-center align-items-start">
              <div class="col-md-9">
                  <div class="card-body text-center">
                      ...
                      <p class="card-text" style="font-size: 22px;">
                          Bij ons ben je 100% baas over je eigen website. Hij staat op je eigen domeinnaam en we bouwen hem met WordPress, een systeem waarmee je eenvoudig zelf je website kunt beheren. Zodat je ons niet voor ieder wissewasje nodig hebt.
                          Laat je het toch liever aan ons over? Ga dan voor onze Mooi Makkelijk Strippenkaart. Zo weet je vooraf al waar je aan toe bent.
                      </p>
                      ...
                      <p class="card-text" style="font-size: 22px;">
                          Niets is zo vervelend als een factuur die achteraf veel hoger uitkomt dan verwacht. Bij ons weet je altijd waar je aan toe bent. Van tevoren maken we goede afspraken, zodat je nooit achteraf voor verrassingen komt te staan. Wel zo eerlijk.
                      </p>
                      ...
                      <p class="card-text" style="font-size: 22px;">
                          Wij staan bekend om onze vriendelijke en goed te bereiken helpdesk. Je kunt ons gewoon bellen of mailen als je ergens niet uit komt. Dan helpen we je, in begrijpelijke taal. Ook krijg je duidelijke uitlegvideo’s, die je nog eens rustig terug kunt kijken op het moment dat het jou uitkomt.
                      </p>
                      ...
                      <p class="card-text" style="font-size: 22px;">
                          Je website staat als een huis. En nu? Als ervaren marketeers kunnen wij je ook helpen op het gebied van online marketing. Zodat je website nog beter vindbaar is in Google en je conversies door het dak gaan dankzij conversieoptimalisatie, e-mailmarketing en/of online adverteren (SEA).
                          <br><br>
                          Nieuwsgierig naar de mogelijkheden? <span style="color:#A74AC7">Neem contact op</span>
                      </p>
                  </div>
              </div>
          </div>
          ...
          <div class="row pt-5 pb-5">
              ...
              <div class="col-md-3">
                  <div class="card-body p-5">
                      <img src="https://s29814.pcdn.co/wp-content/uploads/2021/07/MBO-Logo-Red.svg" class="img-fluid" alt="Partner 1">
                  </div>
              </div>
  
              <div class="col-md-3">
                  <div class="card-body p-5">
                      <img src="https://www.partnersbhm.org/wp-content/uploads/2016/08/Partners-logo-horizonal.jpg" class="img-fluid" alt="Partner 2">
                  </div>
              </div>
  
              <div class="col-md-3">
                  <div class="card-body p-5">
                      <img src="https://bgl.nl/wp-content/uploads/2023/04/bgl-logo.png" class="img-fluid" alt="Partner 3">
                  </div>
              </div>
  
              <div class="col-md-3">
                  <div class="card-body p-5">
                      <img src="https://www.cmpartners.nl/wp-content/themes/cm-partners/images/logo-2021-full.png" class="img-fluid" alt="Partner 4">
                  </div>
              </div>
          </div>
      </div>
