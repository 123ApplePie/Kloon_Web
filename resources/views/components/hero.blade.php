<section class="bg-dark" style="margin-top: 3%;padding-top:5%;">
    <div class="container">
            ...
            <div class="card bg-dark">
              <div class="card-body bg-dark">
                ...
                <div class="d-sm-flex align-items-center justify-content-between bg-dark">
                    <div style="width:120%">
                        <h1 class="text-light" style="font-weight:700;font-size:50px">Website laten maken ?</h1>
          ...
          <div class="col-md-5">
            <div class="card rounded-circle" style="width: 600px; height: 600px; overflow: hidden;">
              <div class="card-body d-flex flex-column justify-content-center align-items-center">
                <!-- Image inside the larger circle -->
                <img src="/img/programmer.jpg" alt="Circle Image" style="width: 600px; height: 600px;">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="d-flex align-items-center justify-content-center text-slate-600" style="background-color: #DBE9FA;margin-top:-150px;">
        <section class="container pt-5 pb-4 " style="">    
